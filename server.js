...
async function getEmployee(action){
...
async function getRoles(action){
...
async function getDeparment(action){
...
async function getEmployeesManager(){
...
async function getEmployeesDepartment(){
...
async function getSalaryDeparment(){
    const departments = await intento.getDepartments();
